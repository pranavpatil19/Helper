...
public sealed class MultiDbTransactionManager : IMultiDbTransactionManager
{
    ...
    /// <summary>
    /// Creates a manager that can open coordinated transactions against multiple databases without MSDTC escalation.
    /// </summary>
    ...
    /// <summary>
    /// Begins a multi-database transaction scope asynchronously.
    /// </summary>
    /// <param name="options">Database options for each participant connection.</param>
    /// <param name="isolationLevel">Isolation level applied to every participant transaction.</param>
    /// <param name="cancellationToken">Propagation token for the async operation.</param>
    /// <returns>An <see cref="IMultiDbTransactionScope"/> that coordinates commits/rollbacks.</returns>
    ...
    /// <summary>
    /// Begins a multi-database transaction scope synchronously.
    /// </summary>
