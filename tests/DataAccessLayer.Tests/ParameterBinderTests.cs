...
public sealed class ParameterBinderTests
{
    ...
    public void TrimStringsOption_TrimsValues()
    {
        ...
        var parameters = new[]
        {
            DbParameterCollectionBuilder.Input("Name", "  alpha  ")
        };
    ...
    public void EnumConversion_UsesUnderlyingType()
    {
        ...
        var parameters = new[]
        {
            DbParameterCollectionBuilder.Input("Status", SampleStatus.Active)
        };
    ...
    public void DateTimeOffset_PostgresConvertedToUtcDateTime()
    {
        ...
        var parameters = new[]
        {
            DbParameterCollectionBuilder.Input("OccurredOn", dto)
        };
    ...
    public void Guid_OracleConvertedToString()
    {
        ...
        var parameters = new[]
        {
            DbParameterCollectionBuilder.Input("Id", guid)
        };
