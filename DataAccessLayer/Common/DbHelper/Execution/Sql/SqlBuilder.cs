...
public sealed class SqlBuilder
{
    ...
    /// <summary>
    /// Applies OFFSET/FETCH pagination using the provided page number and size.
    /// </summary>
    ...
    /// <summary>
    /// Adds a prebuilt parameter definition (useful for structured/tvp parameters).
    /// </summary>
    ...
    /// <summary>
    /// Renders the SQL and parameter definitions for the specified provider.
    /// </summary>
